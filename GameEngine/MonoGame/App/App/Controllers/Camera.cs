...
namespace App.Controllers
{
    class Camera
    {
        ...
        {
          //  Debug.Debugger.Debug_Log("Old Position=" + Position);
           // Vector2 newPosition = new Vector2(position.X - ViewportWidth / 2, position.Y + ViewportHeight / 2);
            //Make the CENTER = Position
            Position = position;
           // Debug.Debugger.Debug_Log("New Position=" + newPosition);
          //  Debug.Debugger.Debug_Log("Center Position=" + position);
